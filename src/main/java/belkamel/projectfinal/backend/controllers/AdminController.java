...
import belkamel.projectfinal.backend.services.SoftwareService;
...
@RestController
@RequestMapping(Values.API_PREFIX + "/admins")
public class AdminController {
    ...
    public ResponseEntity<List<Admin>> getAll() {
        return ResponseEntity.ok(userService.findByRole(Values.getRole("admin")));
    }
